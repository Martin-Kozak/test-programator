<?php
// source: C:\xampp\htdocs\test-programator/config/common.neon
// source: C:\xampp\htdocs\test-programator/config/local.neon
// source: array
...
class Container_d3c513bdb5 extends Nette\DI\Container
{
	protected $tags = ['nette.inject' => ['application.1' => true, 'application.2' => true, 'application.3' => true]];
	...
	protected $wiring = [
		...
		'ArrayAccess' => [2 => ['01', 'application.1']],
		'Countable' => [2 => ['01']],
		'IteratorAggregate' => [2 => ['01']],
		'Traversable' => [2 => ['01']],
		'Nette\Application\Routers\RouteList' => [['01']],
		'App\Model\DatabaseManager' => [['02', '03']],
		'App\Model\DataManager' => [['03']],
		...
		'App\Presenters\HomepagePresenter' => [2 => ['application.1']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\test-programator\app',
			'wwwDir' => 'C:\xampp\htdocs\test-programator\www',
			'vendorDir' => 'C:\xampp\htdocs\test-programator\vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\test-programator/temp',
		];
	}
	...
	public function createService02(): App\Model\DatabaseManager
	{
		return new App\Model\DatabaseManager($this->getService('database.default.context'));
	}


	public function createService03(): App\Model\DataManager
	{
		return new App\Model\DataManager($this->getService('database.default.context'));
	}


	public function createServiceApplication__1(): App\Presenters\HomepagePresenter
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('03'));
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\test-programator/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\test-programator/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\test-programator/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_d3c513bdb5
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=programator-test', 'root', null, ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_d3c513bdb5 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\test-programator/temp/cache/latte');
